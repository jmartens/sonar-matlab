...
echo "</rules>" >> $FILE
sed -i 's/>0</>BLOCKER</' $FILE
sed -i 's/>1</>BLOCKER</' $FILE
sed -i 's/>2</>CRITICAL</' $FILE
sed -i 's/>3</>MAJOR</' $FILE
sed -i 's/>4</>MINOR</' $FILE
sed -i 's/>5</>INFO</' $FILE
sed -i 's/>7</>INFO</' $FILE
...
echo "	</rules>" >> $PROFILE
echo "</profile>" >> $PROFILE
sed -i 's/>0</>BLOCKER</' $PROFILE
sed -i 's/>1</>BLOCKER</' $PROFILE
sed -i 's/>2</>CRITICAL</' $PROFILE
sed -i 's/>3</>MAJOR</' $PROFILE
sed -i 's/>4</>MINOR</' $PROFILE
sed -i 's/>5</>INFO</' $PROFILE
sed -i 's/>7</>INFO</' $PROFILE
