...
public class XPathCheckTest {
  ...
  public void check() {
    ...
    SourceFile file = MatlabAstScanner.scanSingleFile(new File("src/test/resources/checks/xpath.py"), check);
  ...
  public void parseError() {
    ...
    SourceFile file = MatlabAstScanner.scanSingleFile(new File("src/test/resources/checks/parsingError.py"), check);
    CheckMessagesVerifier.verify(file.getCheckMessages())
        .noMore();
  }
